...
user_name = ' PJ'
welcome_message = 'Welcome to Space Invaders and thanks for playing' + user_name
print(welcome_message)

# Part 3
# Use concatenation to build and display a string that includes your first name, last name, and the year you were born

full_name = 'PJ VanDussen'
year_born = 2006
sentence = full_name + ' was born in ' + str(year_born) + "."
print(sentence)
# Part 4
...
# phrase1 = 'I would like to'
# phrase2 = ' travel to Mexico.'
